...
export const _importAdminMaterialLibrary = once(
	() =>
		import("@/views/AdminDashboard/AdminMaterialLibrary/AdminMaterialLibrary"),
);
...
export const AdminMaterialLibrary = lazy(_importAdminMaterialLibrary);
