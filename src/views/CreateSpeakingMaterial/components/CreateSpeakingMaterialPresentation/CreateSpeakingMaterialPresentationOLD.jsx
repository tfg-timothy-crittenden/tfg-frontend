...
const CreateSpeakingMaterialPresentationOLD = ({
	mode = "create",
	sectionStatus = null,
	initialValues,
	...
	return (
		<>
			<form
				...
				autoComplete="off"
			>
				{/* inert blocks pointer + keyboard interaction while data loads */}
				<div
					className={styles.listen_repeat_container}
					{...(isLoading ? { inert: "" } : {})}
				>
					{isLoading && (
						<div
...
export default CreateSpeakingMaterialPresentationOLD;
