...
import { ADMIN_SEGMENTS, ROUTES } from "@/app/routes/routeConfig";
import {
	AcceptInvite,
	AdminClasses,
	AdminDashboard,
				...
				<Routes>
					...
					<Route element={<RoleRoute allowedRoles={["admin"]} />}>
						...
						<Route path={ROUTES.ADMIN_DASHBOARD} element={<AdminDashboard />}>
							<Route path={ADMIN_SEGMENTS.TEACHERS} element={<AdminTeachers />} />
							<Route path={ADMIN_SEGMENTS.CLASSES} element={<AdminClasses />} />
							<Route path={ADMIN_SEGMENTS.MATERIALS} element={<AdminMaterial />} />
							<Route
					...
					{/* Default redirect */}
					<Route path="/" element={<Navigate to={ROUTES.CLASSROOMS} replace />} />
				</Routes>
			</Suspense>
		</>
	);
